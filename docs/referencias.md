# Referencias usadas en el informe base

Estas referencias provienen del documento academico entregado como base del proyecto.

- Ayala Huaringa, J., & Flores Saravia, M. A. (2021). Propuesta de automatizacion para el incremento de la productividad en la gestion documentaria y administrativa de una empresa mediante el uso de automatizacion robotica de procesos. Universidad Ricardo Palma.
- Conexion ESAN. (2020). Transformacion digital en la gestion documental: por que debes aplicarla en tu empresa.
- Ojeda Pino, J. L., Mata Sotelo, C., & Avilez Brocos. Automatizacion del proceso de cobranzas como estrategia para reducir la morosidad en Grupo S.A. Universidad Peruana de Ciencias Aplicadas.
